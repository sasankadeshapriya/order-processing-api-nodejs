...
// Update employee's password by admin
function updateEmployeePasswordByAdmin(req, res) {
    const { email, newPassword } = req.body;

    // Validate new password
    const schema = {
        newPassword: { type: "string", optional: false, min: 8 }
    };
    
    const vldator = new validator();
    const validationResponse = vldator.validate({ newPassword }, schema);
...
module.exports = {
    ...
    updateEmployeePasswordByAdmin:updateEmployeePasswordByAdmin
}